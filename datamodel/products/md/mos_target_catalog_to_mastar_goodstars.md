...
### Naming Convention
$MOS_TARGET/[V_TARG]/[FTYPE]/mos_catalog_to_mastar_goodstars.[FTYPE] with FTYPE='fits' and V_TARG='2.0.0' for DR20.
...
| --- | --- | --- | --- |
 ...
 | target_id | char[22] |  | The primary key identifier in the dr20_mastar_goodstars table. |
 ...
 | best | bool |  | Whether this is considered the best match between the catalog entry and dr20_mastar_goodstars. |
