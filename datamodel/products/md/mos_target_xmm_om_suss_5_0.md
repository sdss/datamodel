# Data Model: mos_target_xmm_om_suss_5_0
...
### Naming Convention
$MOS_TARGET/[V_TARG]/[FTYPE]/mos_xmm_om_suss_5_0.[FTYPE] with FTYPE='fits' and V_TARG='2.0.0' for DR20.
...
| NAXIS1 | 561 | length of dimension 1 |
| NAXIS2 | 1006136 | length of dimension 2 |
...
| --- | --- | --- | --- |
 ...
 | n_summary | int64 |  | Reference number index for the XMM-Newton pointing in which the particular |
 | obsid | char[10] |  | The exclusive 10-digit identification number of the XMM pointing with the |
 | srcnum | int64 |  | The unique reference number within each combined source list created by the |
 ...
 | uvw2_rate | float32 |  | Background-subtracted source count rate in UVW2 corrected for coincidence |
 | uvw2_rate_err | float32 |  | Uncertainty in the background-subtracted source count rate in UVW2 |
 | uvm2_rate | float32 |  | Background-subtracted source count rate in UVM2 corrected for coincidence |
 | uvm2_rate_err | float32 |  | Uncertainty in the background-subtracted source count rate in UVM2 |
 | uvw1_rate | float32 |  | Background-subtracted source count rate in UVW1 corrected for coincidence |
 | uvw1_rate_err | float32 |  | Uncertainty in the background-subtracted source count rate in UVW1 |
 | u_rate | float32 |  | Background-subtracted source count rate in U corrected for coincidence loss |
 | u_rate_err | float32 | counts/s | Uncertainty in the background-subtracted source count rate in U |
 | b_rate | float32 |  | Background-subtracted source count rate in B corrected for coincidence loss |
 | b_rate_err | float32 | counts/s | Uncertainty in the background-subtracted source count rate in B |
 | v_rate | float32 |  | Background-subtracted source count rate in V corrected for coincidence loss |
 ...
 | uvw2_posang | float32 |  | Angle on the sky subtended by the major axis of the source and J2000 |
 | uvm2_posang | float32 |  | Angle on the sky subtended by the major axis of the source and J2000 |
 | uvw1_posang | float32 |  | Angle on the sky subtended by the major axis of the source and J2000 |
 | u_posang | float32 |  | Angle on the sky subtended by the major axis of the source and J2000 north |
 | b_posang | float32 |  | Angle on the sky subtended by the major axis of the source and J2000 north |
 | v_posang | float32 |  | Angle on the sky subtended by the major axis of the source and J2000 north |
 | uvw2_quality_flag | int32 |  | UVW2 quality flag |
 | uvm2_quality_flag | int32 |  | UVM2 quality flag |
 | uvw1_quality_flag | int32 |  | UVW1 quality flag |
 | u_quality_flag | int32 |  | U quality flag |
 | b_quality_flag | int32 |  | B quality flag |
 | v_quality_flag | int32 |  | V quality flag |
 ...
 | uvw2_extended_flag | int16 |  | Spatially extended flag in UVW2 |
 | uvm2_extended_flag | int16 |  | Spatially extended flag in UVM2 |
 | uvw1_extended_flag | int16 |  | Spatially extended flag in UVW1 |
 | u_extended_flag | int16 |  | Spatially extended flag in U |
 | b_extended_flag | int16 |  | Spatially extended flag in B |
 | v_extended_flag | int16 |  | Spatially extended flag in V |
 | uvw2_sky_image | char[3] |  | Flag for stakcked sky images in UVW2 |
 | uvm2_sky_image | char[3] |  | Flag for stakcked sky images in UVM2 |
 | uvw1_sky_image | char[3] |  | Flag for stakcked sky images in UVW1 |
 | u_sky_image | char[3] |  | Flag for stakcked sky images in U |
 | b_sky_image | char[3] |  | Flag for stakcked sky images in B |
 | v_sky_image | char[3] |  | Flag for stakcked sky images in V |
