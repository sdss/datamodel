...
Describes changes to the datamodel product and/or file structure from one release to another
 - WORK
   ...
   - added_primary_header_kwargs: ['MGDRA', 'V_GUIDER', 'DUSTA', 'WINDS', 'AIRTEMP', 'MGDDEC', 'REQTIME', 'SUBFRAME', 'WINDS25M', 'PLATETYP', 'DUSTB', 'MGDPOS', 'TRUSTEMP', 'V_APO', 'PRESSURE', 'GUSTD', 'SRVYMODE', 'CCDTEMP', 'WINDD', 'DIDFLUSH', 'GUSTS', 'HUMIDITY', 'V_SOP', 'M1ZROT', 'V_BOSS', 'DEWPOINT', 'IONPUMP', 'SLITID1', 'DARKTIME', 'WINDD25M', 'LN2TEMP', 'PFERR', 'M2ZROT']
   - removed_primary_header_kwargs: ['MC2TBCT', 'MC2HUMCO', 'MC2TRCB', 'OBJOFFX', 'MC2TBCB', 'MC2HUMHT', 'DAQVER', 'MC2TRCT', 'BOSSVER', 'MC2THT', 'MC2TEMDN', 'OBJOFFY']
 - DR17
   - from: DR16
   - note: No changes
 - DR16
