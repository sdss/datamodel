# Data Model: mos_target_instrument
...
### Naming Convention
$MOS_TARGET/[V_TARG]/mos_target_instrument-[NUM].fits, where V_TARG=1.0.1 for WORK; and NUM = 1..1 to partition the file into parts
