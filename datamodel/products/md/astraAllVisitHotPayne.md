# Data Model: astraAllVisitHotPayne
...
| --- | --- | --- | --- |
 ...
 | delta_ra | float32[7] |  | Offset in right ascension  |
 | delta_dec | float32[7] |  | Offset in declination  |
 ...
 | teff_fullspec | float32 |  | Stellar effective temperature  |
 | e_teff_fullspec | float32 |  | Error on stellar effective temperature  |
 | logg_fullspec | float32 |  | Surface gravity  |
 | e_logg_fullspec | float32 |  | Error on surface gravity  |
 | fe_h_fullspec | float32 |  | [Fe/H]  |
 | e_fe_h_fullspec | float32 |  | Error on [Fe/H]  |
 | v_micro_fullspec | float32 |  | Microturbulence  |
 | e_v_micro_fullspec | float32 |  | Error on microturbulence  |
 | v_sini_fullspec | float32 |  | Projected rotational velocity  |
 | e_v_sini_fullspec | float32 |  | Error on projected rotational velocity  |
 | he_h_fullspec | float32 |  | [He/H]  |
 | e_he_h_fullspec | float32 |  | Error on [He/H]  |
 | c_h_fullspec | float32 |  | [C/H]  |
 | e_c_h_fullspec | float32 |  | Error on [C/H]  |
 | n_h_fullspec | float32 |  | [N/H]  |
 | e_n_h_fullspec | float32 |  | Error on [N/H]  |
 | o_h_fullspec | float32 |  | [O/H]  |
 | e_o_h_fullspec | float32 |  | Error on [O/H]  |
 | si_h_fullspec | float32 |  | [Si/H]  |
 | e_si_h_fullspec | float32 |  | Error on [Si/H]  |
 | s_h_fullspec | float32 |  | [S/H]  |
 | e_s_h_fullspec | float32 |  | Error on [S/H]  |
 | covar_fullspec | float32[121] |  | Covariance matrix (flattened) |
 | chi2_fullspec | float32 |  | Chi-square value |
 | teff_hmasked | float32 |  | Stellar effective temperature  |
 | e_teff_hmasked | float32 |  | Error on stellar effective temperature  |
 | logg_hmasked | float32 |  | Surface gravity  |
 | e_logg_hmasked | float32 |  | Error on surface gravity  |
 | fe_h_hmasked | float32 |  | [Fe/H]  |
 | e_fe_h_hmasked | float32 |  | Error on [Fe/H]  |
 | v_micro_hmasked | float32 |  | Microturbulence  |
 | e_v_micro_hmasked | float32 |  | Error on microturbulence  |
 | v_sini_hmasked | float32 |  | Projected rotational velocity  |
 | e_v_sini_hmasked | float32 |  | Error on projected rotational velocity  |
 | he_h_hmasked | float32 |  | [He/H]  |
 | e_he_h_hmasked | float32 |  | Error on [He/H]  |
 | c_h_hmasked | float32 |  | [C/H]  |
 | e_c_h_hmasked | float32 |  | Error on [C/H]  |
 | n_h_hmasked | float32 |  | [N/H]  |
 | e_n_h_hmasked | float32 |  | Error on [N/H]  |
 | o_h_hmasked | float32 |  | [O/H]  |
 | e_o_h_hmasked | float32 |  | Error on [O/H]  |
 | si_h_hmasked | float32 |  | [Si/H]  |
 | e_si_h_hmasked | float32 |  | Error on [Si/H]  |
 | s_h_hmasked | float32 |  | [S/H]  |
 | e_s_h_hmasked | float32 |  | Error on [S/H]  |
 | covar_hmasked | float32[121] |  | Covariance matrix (flattened) |
 | chi2_hmasked | float32 |  | Chi-square value |
 | raw_e_teff | float32 |  | Error on stellar effective temperature  |
 | raw_e_logg | float32 |  | Error on surface gravity  |
 | raw_e_fe_h | float32 |  | Error on [Fe/H]  |
 | raw_e_v_micro | float32 |  | Error on microturbulence  |
 | raw_e_v_sini | float32 |  | Error on projected rotational velocity  |
 | raw_e_he_h | float32 |  | Error on [He/H]  |
 | raw_e_c_h | float32 |  | Error on [C/H]  |
 | raw_e_n_h | float32 |  | Error on [N/H]  |
 | raw_e_o_h | float32 |  | Error on [O/H]  |
 | raw_e_si_h | float32 |  | Error on [Si/H]  |
 | raw_e_s_h | float32 |  | Error on [S/H]  |
 | raw_e_teff_fullspec | float32 |  | Error on stellar effective temperature  |
 | raw_e_logg_fullspec | float32 |  | Error on surface gravity  |
 | raw_e_fe_h_fullspec | float32 |  | Error on [Fe/H]  |
 | raw_e_v_micro_fullspec | float32 |  | Error on microturbulence  |
 | raw_e_v_sini_fullspec | float32 |  | Error on projected rotational velocity [km/s |
 | raw_e_he_h_fullspec | float32 |  | Error on [He/H]  |
 | raw_e_c_h_fullspec | float32 |  | Error on [C/H]  |
 | raw_e_n_h_fullspec | float32 |  | Error on [N/H]  |
 | raw_e_o_h_fullspec | float32 |  | Error on [O/H]  |
 | raw_e_si_h_fullspec | float32 |  | Error on [Si/H]  |
 | raw_e_s_h_fullspec | float32 |  | Error on [S/H]  |
 | raw_e_teff_hmasked | float32 |  | Error on stellar effective temperature  |
 | raw_e_logg_hmasked | float32 |  | Error on surface gravity  |
 | raw_e_fe_h_hmasked | float32 |  | Error on [Fe/H]  |
 | raw_e_v_micro_hmasked | float32 |  | Error on microturbulence  |
 | raw_e_v_sini_hmasked | float32 |  | Error on projected rotational velocity  |
 | raw_e_he_h_hmasked | float32 |  | Error on [He/H]  |
 | raw_e_c_h_hmasked | float32 |  | Error on [C/H]  |
 | raw_e_n_h_hmasked | float32 |  | Error on [N/H]  |
 | raw_e_o_h_hmasked | float32 |  | Error on [O/H]  |
 | raw_e_si_h_hmasked | float32 |  | Error on [Si/H]  |
 | raw_e_s_h_hmasked | float32 |  | Error on [S/H]  |
