...
| --- | --- | --- | --- |
 ...
 | RA_LIST | char[197] |  | List of measured RA per exposure |
 | DEC_LIST | char[179] |  | List of measured DEC per exposure |
 | DELTA_RA_LIST | char[71] |  | List of designed RA offsets per exposure |
 | DELTA_DEC_LIST | char[71] |  | List of designed DEC offsets per exposure |
 | FIBER_OFFSET | int64 |  | Flag identifying the fiber was offset by design |
 | XFOCAL | char[161] |  | Hole/robot x-axis position in focal plane |
 | YFOCAL | char[161] |  | Hole/robot y-axis position in focal plane |
 ...
 | MOON_DIST | char[107] |  | Mean Moon-target separation of Coadded Spectra |
