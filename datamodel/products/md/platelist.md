...
## Basic Information
This file contains the list of reduced BOSS plates, with associated meta-data gathered from the design/configuration files and the reductions. This file is superceded in SDSS-V by the fieldlist file.
