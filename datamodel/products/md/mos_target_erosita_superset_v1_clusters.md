# Data Model: mos_target_erosita_superset_v1_clusters
...
| NAXIS1 | 188 | length of dimension 1 |
| NAXIS2 | 512657 | length of dimension 2 |
...
| --- | --- | --- | --- |
 ...
 | xmatch_method | char[9] |  | The X-ray-to-optical/IR cross-match method that was used in this case e.g. 'XPS-ML/NWAY', 'CLUSTERS_EFEDS_MULTIPLE' etc |
