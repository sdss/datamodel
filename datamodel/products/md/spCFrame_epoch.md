# Data Model: spCFrame_epoch


flux-calibrated spectra extracted CCD exposure for epoch coadd
...
| --- | --- | --- | --- |
 ...
 | DECCAT | float64 | deg | Catalog RA in ICRS coordinates at coord_epoch |
