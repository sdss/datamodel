...
Describes changes to the datamodel product and/or file structure from one release to another
 - WORK
   ...
   - added_primary_header_kwargs: ['SUBFRAME', 'SLITID1', 'DEWPOINT', 'HARTMANN', 'WINDD25M', 'CCDTEMP', 'LN2TEMP', 'GUSTD', 'M2XTILT', 'M1YTRAN', 'SPA', 'DEC', 'DUSTB', 'TRUSTEMP', 'EXPTIME', 'M2YTRAN', 'TAI-BEG', 'MC1TBCB', 'M1YTILT', 'AIRTEMP', 'ALT', 'FOCUS', 'CARTID', 'HGCD', 'DECDEG', 'RADEG', 'MC1HUMCO', 'WINDS', 'V_APO', 'FF', 'M1XTRAN', 'PLATETYP', 'IONPUMP', 'PLATEID', 'SCALE', 'M1PISTON', 'CHECKSUM', 'MJD', 'FLAVOR', 'M1XTILT', 'COLLA', 'MC1TRCT', 'M2PISTON', 'CAMERAS', 'GUSTS', 'WINDD', 'RA', 'DUSTA', 'AZ', 'MC1TBCT', 'POINTING', 'NE', 'COLLC', 'NAME', 'M2XTRAN', 'COLLB', 'MC1TEMDN', 'M2ZROT', 'FFS', 'EXPOSURE', 'MC1HUMHT', 'DARKTIME', 'M1ZROT', 'COMMENT', 'PRESSURE', 'WINDS25M', 'REQTIME', 'PFERR', 'OBJSYS', 'M2YTILT', 'DATE-OBS', 'V_BOSS', 'IPA', 'HUMIDITY', 'MC1THT', 'DIDFLUSH', 'MAPID', 'MC1TRCB']
   - removed_primary_header_kwargs: ['CAMERA', 'OBSID', 'DATASEC', 'DAQVER']
 - DR17
   - from: DR16
   - note: No changes
 - DR16
