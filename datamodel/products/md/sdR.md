...
Describes changes to the datamodel product and/or file structure from one release to another
 ...
 - DR18
   ...
   - added_primary_header_kwargs: ['SPA', 'CARTID', 'RADEG', 'NAME', 'LN2TEMP', 'SCALE', 'HARTMANN', 'M1PISTON', 'WINDD', 'EXPTIME', 'MC1TRCB', 'DATE-OBS', 'V_APO', 'PLATEID', 'PLATETYP', 'MAPID', 'SUBFRAME', 'M1YTILT', 'M1XTILT', 'M2PISTON', 'REQTIME', 'HGCD', 'WINDS25M', 'OBJSYS', 'MC1TRCT', 'DEC', 'M1YTRAN', 'FLAVOR', 'COLLB', 'AIRTEMP', 'HUMIDITY', 'ALT', 'MC1THT', 'GUSTS', 'NE', 'M2ZROT', 'WINDS', 'IONPUMP', 'COLLC', 'M2XTILT', 'TRUSTEMP', 'TAI-BEG', 'FOCUS', 'CCDTEMP', 'MC1HUMCO', 'COMMENT', 'PFERR', 'DEWPOINT', 'MC1HUMHT', 'MC1TBCT', 'FFS', 'AZ', 'M2YTILT', 'PRESSURE', 'M2XTRAN', 'FF', 'CAMERAS', 'WINDD25M', 'RA', 'IPA', 'MC1TEMDN', 'DUSTA', 'M2YTRAN', 'M1XTRAN', 'CHECKSUM', 'COLLA', 'DIDFLUSH', 'DUSTB', 'SLITID1', 'DARKTIME', 'DECDEG', 'MC1TBCB', 'MJD', 'M1ZROT', 'V_BOSS', 'EXPOSURE', 'GUSTD', 'POINTING']
   - removed_primary_header_kwargs: ['OBSID', 'CAMERA', 'DATASEC', 'DAQVER']
 - DR17
   - from: DR16
   - note: No changes
 - DR16
