...
### Releases
DR9, DR10, DR12, DR11, DR13, DR14, DR15, DR16, DR17, DR18
...
Describes changes to the datamodel product and/or file structure from one release to another
 - DR18
   ...
   - added_primary_header_kwargs: ['FF', 'GUSTD', 'DARKTIME', 'FFS', 'WINDS25M', 'V_BOSS', 'MC1TBCT', 'AIRTEMP', 'IONPUMP', 'EXPTIME', 'FLAVOR', 'M2PISTON', 'COLLA', 'MC1TBCB', 'ALT', 'CARTID', 'M2YTRAN', 'DECDEG', 'RA', 'PLATETYP', 'SPA', 'DEWPOINT', 'TAI-BEG', 'MC1TRCB', 'MC1TRCT', 'M1XTILT', 'AZ', 'HARTMANN', 'M1ZROT', 'FOCUS', 'PFERR', 'HUMIDITY', 'LN2TEMP', 'M2XTRAN', 'CHECKSUM', 'RADEG', 'MC1HUMHT', 'NAME', 'IPA', 'SCALE', 'WINDD25M', 'M2ZROT', 'POINTING', 'EXPOSURE', 'M2YTILT', 'M2XTILT', 'CAMERAS', 'MC1THT', 'COMMENT', 'OBJSYS', 'MC1HUMCO', 'WINDS', 'M1XTRAN', 'WINDD', 'MAPID', 'COLLC', 'DIDFLUSH', 'TRUSTEMP', 'M1YTILT', 'DUSTA', 'MC1TEMDN', 'GUSTS', 'REQTIME', 'CCDTEMP', 'HGCD', 'DEC', 'MJD', 'M1YTRAN', 'COLLB', 'SLITID1', 'M1PISTON', 'PLATEID', 'SUBFRAME', 'PRESSURE', 'NE', 'DUSTB', 'V_APO', 'DATE-OBS']
   - removed_primary_header_kwargs: ['DAQVER', 'CAMERA', 'DATASEC', 'OBSID']
 - DR17
   - from: DR16
   - note: No changes
 - DR16
