...
Describes changes to the datamodel product and/or file structure from one release to another
 ...
 - DR18
   ...
   - added_primary_header_kwargs: ['M1YTILT', 'M1XTILT', 'DEC', 'RA', 'PRESSURE', 'M2ZROT', 'SCALE', 'M2XTRAN', 'MC1TBCB', 'LN2TEMP', 'POINTING', 'NAME', 'M2YTILT', 'MC1HUMHT', 'SUBFRAME', 'M2PISTON', 'IONPUMP', 'REQTIME', 'FOCUS', 'PLATEID', 'GUSTS', 'MC1THT', 'COLLA', 'PLATETYP', 'OBJSYS', 'WINDD', 'CCDTEMP', 'M1XTRAN', 'GUSTD', 'FLAVOR', 'V_BOSS', 'TAI-BEG', 'M2XTILT', 'CHECKSUM', 'MC1TEMDN', 'DATE-OBS', 'DARKTIME', 'MC1TRCB', 'DUSTA', 'WINDS', 'COLLC', 'EXPTIME', 'AZ', 'FF', 'COMMENT', 'HGCD', 'TRUSTEMP', 'M1ZROT', 'HUMIDITY', 'V_APO', 'SPA', 'CARTID', 'MC1TRCT', 'M1PISTON', 'MC1HUMCO', 'NE', 'MJD', 'DIDFLUSH', 'ALT', 'DEWPOINT', 'M1YTRAN', 'M2YTRAN', 'SLITID1', 'WINDD25M', 'PFERR', 'MC1TBCT', 'AIRTEMP', 'FFS', 'WINDS25M', 'DUSTB', 'IPA', 'COLLB', 'MAPID', 'RADEG', 'CAMERAS', 'HARTMANN', 'EXPOSURE', 'DECDEG']
