...
Describes changes to the datamodel product and/or file structure from one release to another
 - WORK
   ...
   - added_primary_header_kwargs: ['LN2TEMP', 'DUSTB', 'IONPUMP', 'M1ZROT', 'AIRTEMP', 'MC1TBCB', 'M2PISTON', 'SPA', 'DUSTA', 'WINDD', 'REQTIME', 'GUSTS', 'MC1TRCT', 'GUSTD', 'COLLC', 'COLLB', 'PLATETYP', 'PLATEID', 'CARTID', 'MC1TRCB', 'M2XTILT', 'DEWPOINT', 'TAI-BEG', 'HGCD', 'DIDFLUSH', 'CAMERAS', 'MC1TEMDN', 'SUBFRAME', 'MC1TBCT', 'WINDS', 'DARKTIME', 'AZ', 'DECDEG', 'M1XTRAN', 'FLAVOR', 'V_APO', 'MAPID', 'M1PISTON', 'M1YTRAN', 'SLITID1', 'PFERR', 'WINDD25M', 'COLLA', 'PRESSURE', 'MC1HUMCO', 'TRUSTEMP', 'POINTING', 'CHECKSUM', 'FF', 'M2XTRAN', 'M1YTILT', 'M2YTILT', 'HARTMANN', 'ALT', 'MJD', 'FOCUS', 'COMMENT', 'DATE-OBS', 'DEC', 'RA', 'M2YTRAN', 'NAME', 'RADEG', 'V_BOSS', 'EXPOSURE', 'WINDS25M', 'FFS', 'NE', 'HUMIDITY', 'MC1HUMHT', 'M1XTILT', 'SCALE', 'EXPTIME', 'MC1THT', 'M2ZROT', 'OBJSYS', 'IPA', 'CCDTEMP']
   - removed_primary_header_kwargs: ['DAQVER', 'DATASEC', 'CAMERA', 'OBSID']
 - DR17
   - from: DR16
   - note: No changes
 - DR16
