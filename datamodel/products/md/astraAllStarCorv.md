# Data Model: astraAllStarCorv


Results from the Corv astra pipeline for each star
...
### Naming Convention
$MWM_ASTRA/0.6.0/summary/astraAllStarCorv-0.6.0.fits.gz
...
| CREATED | 24-09-13 14:38:41 | File creation time (UTC %y-%m-%d %H:%M:%S) |
...
### HDU1: 
Corv results for each star from BOSS
...
| NAXIS1 | 811 | length of dimension 1 |
...
| CHECKSUM | ffFUgcCRfcCRfcCR | HDU checksum updated 2024-09-13T08:38:41 |
| DATASUM | 0 | data unit checksum updated 2024-09-13T08:38:41 |
...
### HDU2: 
Corv results for each star from APOGEE
...
| BITPIX | 8 | array data type |
| NAXIS | 2 | number of array dimensions |
| NAXIS1 | 847 | length of dimension 1 |
| NAXIS2 | 0 | length of dimension 2 |
| PCOUNT | 0 | number of group parameters |
| GCOUNT | 1 | number of groups |
...
| COMMENT | See https://catalog.unwise.me/catalogs.html |  |
| COMMENT | See https://irsa.ipac.caltech.edu/data/SPITZER/GLIMPSE/gator_docs/ |  |
| CHECKSUM | e1HVe0GUe0GUe0GU | HDU checksum updated 2024-09-13T08:38:42 |
| DATASUM | 0 | data unit checksum updated 2024-09-13T08:38:42 |
