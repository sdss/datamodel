...
| --- | --- | --- | --- |
 ...
 | HAS_VI | float64 |  | if this object has been visual inspected |
 ...
 | FE_UV_OPT_PARA | float64[6] |  | FeII template parameters (normalization, FWHM and shift) for UV and optical band |
 | FE_UV_OPT_PARA_ERR | float64[6] |  | uncertainties for the FeII template parameters |
 ...
 | HgHd_STAT | float64[2] |  | Complex line window pixel number, reduced chi square |
