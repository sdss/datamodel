...
### Naming Convention
$BHM_EFEDS_SPECCOMP/[V_SPECCOMP]/eFEDS_SDSSV_spec_results-[V_SPECCOMP].fits, where V_SPECCOMP=v1.4.3 for DR18, DR19 and DR20. or eFEDS_SDSSV_spec_results-v1.4.3.fits but with regex pattern matches
