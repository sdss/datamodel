...
Describes changes to the datamodel product and/or file structure from one release to another
 - WORK
   ...
   - added_primary_header_kwargs: ['SKYMODEL SKYE MOONDIST', 'SKYMODEL SCI MOONSCAL', 'JD', 'IFIBVAR', 'WAVE SKYOFF_r2', 'SKYMODEL SCI RHO', 'SKYMODEL SKYE O2COLUMN', 'AMP4 RDNOISE', 'AMP1 TRIMSEC', 'SKYMODEL SKYW RHO', 'SKYMODEL SCI ALT', 'SKYMODEL SKYW SSA', 'SKYMODEL SCI PRES', 'SKYMODEL SKYW TIME', 'SKYMODEL SKYW PRES', 'AMP4 OVERSCAN_STD', 'AMP2 GAIN', 'SKYMODEL SKYW ALPHA', 'SKYMODEL SKYW SM_HMIN', 'FIBER WIDTH AVG', 'SKYMODEL SKYE MOONSCAL', 'SKYMODEL SKYW LAT_ECL', 'SKYMODEL SCI EMIS_STR', 'AMP3 GAIN', 'AMP2 TRIMSEC', 'SKYMODEL SKYE CALCDS', 'SKYMODEL SKYW O2COLUMN', 'WAVE SKYOFF_z3', 'AMP3 TRIMSEC', 'FIBER CENT MED', 'SKYMODEL SCI ALTMOON', 'SKYMODEL SKYW SM_H', 'SKYMODEL SKYW LON_ECL', 'AMP1 OVERSCAN', 'SKYMODEL SKYW MOONDIST', 'AMP1 GAIN', 'SKYMODEL SKYE PRES', 'SKYMODEL SKYE ALPHA', 'STD12RIN', 'SKYMODEL SKYE RHO', 'FIBER CENT MIN', 'STD12ZAB', 'AMP2 OVERSCAN', 'AMP4 GAIN', 'FIBER CENT MAX', 'FIBER WIDTH MIN', 'SKYMODEL SKYE MSOLFLUX', 'STD12RAB', 'STD12BAB', 'SKYMODEL SCI LAT_ECL', 'SKYMODEL SCI SM_HMIN', 'GEOCORONAL SCI SHADOW_HEIGHT', 'SKYMODEL SCI LON_ECL', 'FIBER CENT AVG', 'SKYMODEL SKYW CALCDS', 'SKYMODEL SKYW ALT', 'BZERO', 'AMP1 RDNOISE', 'AMP4 TRIMSEC', 'WAVE SKYOFF_z2', 'AMP2 RDNOISE', 'SKYMODEL SKYW MOONSCAL', 'WAVE SKYOFF_b2', 'SKYMODEL SKYE SM_HMIN', 'SKYMODEL SCI MSOLFLUX', 'STD12BIN', 'SKYMODEL SKYE SM_H', 'SKYMODEL SKYW ALTMOON', 'FIBER WIDTH MAX', 'WAVE SKYOFF_r1', 'SKYMODEL SCI SM_H', 'FIBER WIDTH MED', 'WAVE SKYOFF_b1', 'SKYMODEL SCI SEASON', 'FIBER CENT SIG', 'SKYMODEL SKYE TEMP_STR', 'FFIBVAR', 'SKYMODEL SKYE ALTMOON', 'WAVE SKYOFF_b3', 'SKYMODEL SKYE LON_ECL', 'SKYMODEL SCI MOONDIST', 'SKYMODEL SKYW EMIS_STR', 'SKYMODEL SCI TEMP_STR', 'SKYMODEL SCI SSA', 'SKYMODEL SCI TIME', 'SKYMODEL SCI O2COLUMN', 'AMP3 OVERSCAN', 'STD12ZIN', 'WAVE SKYOFF_r3', 'AMP4 OVERSCAN', 'FIBER WIDTH SIG', 'BSCALE', 'SKYMODEL SKYE TIME', 'SKYMODEL SKYE LAT_ECL', 'SKYMODEL SCI ALPHA', 'GEOCORONAL SKYE SHADOW_HEIGHT', 'FLATNAME', 'SKYMODEL SKYW SEASON', 'AMP3 RDNOISE', 'SKYMODEL SCI CALCDS', 'SKYMODEL SKYE SEASON', 'AMP2 OVERSCAN_STD', 'SKYMODEL SKYE EMIS_STR', 'AMP3 OVERSCAN_STD', 'SKYMODEL SKYE ALT', 'WAVE SKYOFF_z1', 'AMP1 OVERSCAN_STD', 'SKYMODEL SKYW TEMP_STR', 'SKYMODEL SKYE SSA', 'GEOCORONAL SKYW SHADOW_HEIGHT', 'SKYMODEL SKYW MSOLFLUX']
   - removed_primary_header_kwargs: ['Z2 AMP1 OVERSCAN_STD', 'Z1 AMP3 OVERSCAN_STD', 'R1 FIBER WIDTH_STD', 'SKYMODEL SM_HMIN', 'R1 AMP4 OVERSCAN_MED', 'Z2 AMP2 OVERSCAN_MED', 'SCI5DE', 'B3 AMP1 GAIN', 'Z2 FIBER WIDTH_STD', 'SCI8ZAB', 'Z2 AMP3 OVERSCAN_MED', 'B2 AMP3 RDNOISE', 'R1 AMP4 GAIN', 'Z3 FIBER WIDTH_STD', 'SCI5ZAB', 'SKY MOON_DEC', 'R3 AMP2 OVERSCAN_MED', 'SCI8FIB', 'Z2 AMP4 RDNOISE', 'R2 WAVE SKYOFF', 'SCIRA', 'Z1 FIBER WIDTH_STD', 'STDSENMZ', 'Z2 AMP2 TRIMSEC', 'B1 AMP2 RDNOISE', 'R3 FIBER SHIFT', 'SCIPA', 'Z2 FIBER WIDTH_AVG', 'MODSENMR', 'Z3 FIBER CENT_MAX', 'Z3 AMP2 RDNOISE', 'B1 FIBER WIDTH_AVG', 'SKY MOON_RA', 'R3 AMP3 GAIN', 'R1 AMP1 OVERSCAN_MED', 'SCI4RAB', 'R1 AMP1 OVERSCAN_STD', 'B3 FIBER SHIFT', 'SCI9RA', 'Z1 AMP1 OVERSCAN_MED', 'SCI5BAB', 'Z2 FIBER CENT_MIN', 'Z1 FIBER WIDTH_MIN', 'SKY MOON_PHASE', 'SCI4DE', 'SCI12ZIN', 'R3 AMP1 OVERSCAN_STD', 'B2 AMP1 TRIMSEC', 'Z1 AMP2 TRIMSEC', 'STDSENMR', 'SKY SCI_SKYW_SEP', 'Z2 AMP4 GAIN', 'STD3HRV', 'SCI4BIN', 'SCI9ZIN', 'Z1 FIBERFLAT CORR', 'R1 FIBER WIDTH_AVG', 'R2 AMP1 GAIN', 'SKYMODEL PRES', 'R3 FIBER CENT_AVG', 'R3 AMP4 OVERSCAN_STD', 'R3 WAVE SKYOFF', 'STD15HRV', 'SCI9RIN', 'B3 FIBER CENT_STD', 'Z2 AMP4 OVERSCAN_MED', 'B2 AMP2 TRIMSEC', 'Z2 FIBER SHIFT', 'Z1 AMP2 GAIN', 'SCI8ID', 'B1 AMP4 OVERSCAN_MED', 'SKYWDEC', 'R2 AMP1 RDNOISE', 'SCI5FIB', 'SCI12RIN', 'B1 FIBER SHIFT', 'Z3 FIBER WIDTH_AVG', 'B3 AMP4 OVERSCAN_MED', 'SKYMODEL SKYW_LAT_ECL', 'SKYMODEL SSA', 'R1 AMP4 OVERSCAN_STD', 'B3 AMP3 TRIMSEC', 'STDSENRB', 'Z2 FIBER CENT_AVG', 'SCI12RA', 'B1 AMP1 OVERSCAN_STD', 'Z1 AMP2 RDNOISE', 'R3 FIBER WIDTH_MAX', 'SKY SKYW_ALT', 'Z2 AMP3 RDNOISE', 'R3 AMP1 OVERSCAN_MED', 'B3 FIBER WIDTH_MIN', 'SCI4BAB', 'SCI4FIB', 'R2 FIBER WIDTH_STD', 'Z1 AMP1 TRIMSEC', 'SCI9DE', 'B1 FIBERFLAT CORR', 'SCISENRB', 'STD4HRV', 'Z1 AMP4 GAIN', 'SKY SKYW_SH_HGHT', 'R2 AMP4 GAIN', 'SKYMODEL O2COLUMN', 'Z3 AMP2 OVERSCAN_MED', 'R1 AMP1 GAIN', 'SKYMODEL SKYE_LON_ECL', 'B2 FIBER WIDTH_STD', 'SCI1ID', 'Z1 FIBER CENT_STD', 'SCI9BIN', 'B3 AMP4 OVERSCAN_STD', 'B2 AMP1 OVERSCAN_STD', 'B2 FIBERFLAT CORR', 'Z1 FIBER CENT_AVG', 'SKY MOON_FLI', 'Z3 AMP4 TRIMSEC', 'SCI1FIB', 'R2 AMP2 RDNOISE', 'SCI1DE', 'R2 AMP2 OVERSCAN_STD', 'Z2 AMP4 OVERSCAN_STD', 'R3 AMP1 RDNOISE', 'Z3 AMP2 OVERSCAN_STD', 'SCISENMB', 'B3 AMP1 TRIMSEC', 'B1 AMP3 TRIMSEC', 'B2 AMP4 TRIMSEC', 'Z1 AMP1 GAIN', 'Z2 AMP2 OVERSCAN_STD', 'R1 AMP2 GAIN', 'SKYMODEL MSOLFLUX', 'SKY SCI_SKYE_SEP', 'B3 AMP1 RDNOISE', 'R3 AMP4 OVERSCAN_MED', 'SKYEDEC', 'R3 AMP4 RDNOISE', 'B2 FIBER CENT_AVG', 'SKYMODEL EMIS_STR', 'Z2 AMP3 OVERSCAN_STD', 'SCI5RAB', 'R3 AMP2 TRIMSEC', 'SCI8BIN', 'B3 FIBER CENT_AVG', 'B3 AMP2 OVERSCAN_STD', 'SCI5RA', 'B3 FIBER WIDTH_AVG', 'R3 FIBER CENT_MAX', 'R1 WAVE SKYOFF', 'B2 AMP3 OVERSCAN_STD', 'R2 AMP2 GAIN', 'SKYMODEL SEASON', 'Z3 AMP3 TRIMSEC', 'R2 AMP1 OVERSCAN_MED', 'Z1 AMP3 RDNOISE', 'R1 AMP1 RDNOISE', 'B2 AMP4 OVERSCAN_MED', 'QAFLAG', 'Z2 FIBER WIDTH_MAX', 'Z1 FIBER SHIFT', 'STD12HRV', 'R3 AMP1 GAIN', 'R2 FIBER WIDTH_AVG', 'R1 FIBER CENT_STD', 'SCI5ZIN', 'Z1 AMP4 TRIMSEC', 'B2 FIBER SHIFT', 'Z2 FIBER WIDTH_MIN', 'Z1 AMP3 GAIN', 'SCI1ZIN', 'STD8HRV', 'B2 AMP1 OVERSCAN_MED', 'R2 AMP4 OVERSCAN_MED', 'SCI8RA', 'SCI4ZIN', 'R2 AMP4 OVERSCAN_STD', 'Z3 FIBER WIDTH_MIN', 'SKYMODEL SCI_LON_ECL', 'Z1 AMP4 RDNOISE', 'B3 FIBER CENT_MIN', 'B1 FIBER CENT_STD', 'B1 AMP1 TRIMSEC', 'R1 FIBER WIDTH_MIN', 'B1 AMP2 GAIN', 'B3 AMP3 OVERSCAN_STD', 'SCI9RAB', 'R2 AMP3 RDNOISE', 'SCIDEC', 'R1 AMP3 OVERSCAN_STD', 'R2 AMP3 GAIN', 'B1 AMP4 GAIN', 'R3 FIBER WIDTH_AVG', 'Z1 FIBER CENT_MIN', 'SKYMODEL TIME', 'R3 AMP3 OVERSCAN_STD', 'SKY SCI_MOON_SEP', 'B1 AMP4 OVERSCAN_STD', 'B3 AMP4 GAIN', 'Z3 AMP2 GAIN', 'SCISENRR', 'SKYWPA', 'STD1HRV', 'SKY SKYE_SH_HGHT', 'R2 AMP3 OVERSCAN_STD', 'SCI2ZIN', 'SKYWRA', 'B1 AMP1 RDNOISE', 'STD9HRV', 'B3 AMP4 RDNOISE', 'SKYMODEL SM_H', 'SKY SKYE_MOON_SEP', 'R1 FIBER WIDTH_MAX', 'SCI8DE', 'Z1 AMP1 RDNOISE', 'B3 AMP3 OVERSCAN_MED', 'B2 AMP1 RDNOISE', 'R3 FIBER CENT_STD', 'Z1 WAVE SKYOFF', 'B2 FIBER CENT_MIN', 'WAVE HELIORV_SCI', 'B1 AMP3 GAIN', 'Z3 WAVE SKYOFF', 'Z2 AMP1 RDNOISE', 'QAQUAL', 'R2 FIBER CENT_MIN', 'SCI1BAB', 'Z1 AMP2 OVERSCAN_STD', 'SCI2ID', 'Z2 AMP3 TRIMSEC', 'R2 AMP1 OVERSCAN_STD', 'R2 AMP3 OVERSCAN_MED', 'STDSENRZ', 'R2 FIBER CENT_MAX', 'STD2HRV', 'MODSENRB', 'Z3 AMP4 OVERSCAN_STD', 'B2 AMP3 OVERSCAN_MED', 'Z3 FIBER SHIFT', 'B3 FIBERFLAT CORR', 'SKY SKYW_MOON_SEP', 'SKYMODEL CALCDS', 'B3 AMP1 OVERSCAN_MED', 'R2 FIBER CENT_STD', 'R3 AMP3 TRIMSEC', 'B1 AMP1 OVERSCAN_MED', 'SCI2RAB', 'Z1 AMP4 OVERSCAN_STD', 'R2 AMP2 TRIMSEC', 'R1 AMP4 RDNOISE', 'B1 AMP2 OVERSCAN_MED', 'SCI4ID', 'SCI12ID', 'SCI1RA', 'B1 AMP3 OVERSCAN_STD', 'R3 AMP4 GAIN', 'SKY SKYE_ALT', 'B2 AMP3 GAIN', 'R1 AMP1 TRIMSEC', 'SKYMODEL SKYW_LON_ECL', 'R2 AMP2 OVERSCAN_MED', 'B2 AMP2 RDNOISE', 'B2 AMP2 GAIN', 'WAVE HELIORV_SKYW', 'B2 AMP1 GAIN', 'B1 FIBER CENT_MAX', 'B2 FIBER CENT_MAX', 'Z1 AMP3 TRIMSEC', 'R2 FIBER WIDTH_MAX', 'R3 AMP2 RDNOISE', 'R2 AMP4 RDNOISE', 'MODSENRR', 'R3 AMP3 OVERSCAN_MED', 'Z3 AMP2 TRIMSEC', 'R1 FIBER CENT_AVG', 'SCI12DE', 'R1 FIBER CENT_MIN', 'Z2 AMP2 RDNOISE', 'SCI4ZAB', 'SKYMODEL MOONDIST', 'B2 AMP4 GAIN', 'Z3 AMP3 OVERSCAN_MED', 'B2 AMP4 OVERSCAN_STD', 'SCI1ZAB', 'B2 FIBER WIDTH_MAX', 'Z3 AMP1 RDNOISE', 'R3 FIBER WIDTH_STD', 'SCI5ID', 'B3 AMP2 RDNOISE', 'SCI1RAB', 'B3 AMP1 OVERSCAN_STD', 'Z1 FIBER WIDTH_MAX', 'SKYMODEL TEMP_STR', 'SCI8BAB', 'R1 FIBER SHIFT', 'STD10HRV', 'SCI9BAB', 'SKY MOON_ALT', 'SKYMODEL SCI_LAT_ECL', 'Z3 FIBER CENT_MIN', 'STD14HRV', 'R3 FIBERFLAT CORR', 'SCI8ZIN', 'B1 WAVE SKYOFF', 'B1 AMP4 TRIMSEC', 'B2 AMP3 TRIMSEC', 'Z2 AMP3 GAIN', 'Z2 WAVE SKYOFF', 'B2 WAVE SKYOFF', 'Z2 FIBER CENT_MAX', 'Z3 AMP1 OVERSCAN_MED', 'B1 AMP3 OVERSCAN_MED', 'B2 FIBER CENT_STD', 'SCI4RA', 'SCI2BAB', 'Z3 FIBERFLAT CORR', 'SCI5BIN', 'STDSENMB', 'SCI12FIB', 'Z1 AMP1 OVERSCAN_STD', 'R3 FIBER WIDTH_MIN', 'R1 AMP3 OVERSCAN_MED', 'SCI8RAB', 'R1 AMP3 TRIMSEC', 'B2 FIBER WIDTH_MIN', 'R3 AMP3 RDNOISE', 'R3 FIBER CENT_MIN', 'B3 FIBER CENT_MAX', 'Z2 AMP2 GAIN', 'B3 FIBER WIDTH_MAX', 'SKY SUN_ALT', 'SCI1BIN', 'Z1 AMP4 OVERSCAN_MED', 'R1 AMP2 RDNOISE', 'STD7HRV', 'B3 AMP3 GAIN', 'SKY SCI_ALT', 'B1 AMP3 RDNOISE', 'Z3 AMP4 GAIN', 'SCI1RIN', 'B3 AMP3 RDNOISE', 'STD11HRV', 'SCI12ZAB', 'R1 FIBERFLAT CORR', 'SCI2RA', 'Z3 AMP1 OVERSCAN_STD', 'B1 AMP4 RDNOISE', 'MODSENMB', 'B1 FIBER CENT_AVG', 'SCISENMZ', 'Z2 AMP4 TRIMSEC', 'SCI2BIN', 'Z3 AMP4 RDNOISE', 'Z3 AMP4 OVERSCAN_MED', 'Z1 AMP3 OVERSCAN_MED', 'B3 AMP2 OVERSCAN_MED', 'Z3 AMP3 RDNOISE', 'Z2 FIBER CENT_STD', 'R3 AMP2 GAIN', 'COMMIT', 'R1 AMP2 TRIMSEC', 'R2 FIBER CENT_AVG', 'B1 AMP1 GAIN', 'SCI2DE', 'MODSENRZ', 'B3 AMP2 GAIN', 'Z3 FIBER WIDTH_MAX', 'B3 AMP2 TRIMSEC', 'B1 AMP2 TRIMSEC', 'R1 AMP2 OVERSCAN_STD', 'STD13HRV', 'B1 FIBER WIDTH_STD', 'R1 AMP2 OVERSCAN_MED', 'Z3 AMP1 GAIN', 'R3 AMP4 TRIMSEC', 'SCI12RAB', 'Z1 AMP2 OVERSCAN_MED', 'STD5HRV', 'STD6HRV', 'SCI9FIB', 'Z3 AMP1 TRIMSEC', 'Z3 AMP3 OVERSCAN_STD', 'B1 FIBER WIDTH_MIN', 'Z3 FIBER CENT_STD', 'R2 FIBER SHIFT', 'Z2 AMP1 GAIN', 'Z1 FIBER CENT_MAX', 'R2 FIBERFLAT CORR', 'R2 AMP1 TRIMSEC', 'SCI8RIN', 'Z3 FIBER CENT_AVG', 'B2 AMP4 RDNOISE', 'WAVE HELIORV_SKYE', 'SCI5RIN', 'Z2 AMP1 OVERSCAN_MED', 'B3 WAVE SKYOFF', 'R3 AMP2 OVERSCAN_STD', 'R3 AMP1 TRIMSEC', 'SKYERA', 'SKYEPA', 'Z2 AMP1 TRIMSEC', 'STDSENRR', 'Z3 AMP3 GAIN', 'SCI2FIB', 'Z1 FIBER WIDTH_AVG', 'SCISENMR', 'Z2 FIBERFLAT CORR', 'B3 AMP4 TRIMSEC', 'SCI12BAB', 'SCI9ID', 'SKYMODEL MOONSCAL', 'B1 FIBER WIDTH_MAX', 'SCI4RIN', 'R2 AMP3 TRIMSEC', 'SKY SCI_SH_HGHT', 'SCI2ZAB', 'B2 AMP2 OVERSCAN_STD', 'R1 AMP4 TRIMSEC', 'R2 AMP4 TRIMSEC', 'MODSENMZ', 'R1 AMP3 RDNOISE', 'SCI12BIN', 'B2 FIBER WIDTH_AVG', 'B2 AMP2 OVERSCAN_MED', 'B1 FIBER CENT_MIN', 'SKYMODEL SKYE_LAT_ECL', 'R1 AMP3 GAIN', 'B1 AMP2 OVERSCAN_STD', 'SCI2RIN', 'SCI9ZAB', 'SCISENRZ', 'R1 FIBER CENT_MAX', 'B3 FIBER WIDTH_STD', 'R2 FIBER WIDTH_MIN']
 - DR20
   - from: DR19
   - added_hdus: ['FLUXCAL_MOD', 'FLUXCAL_STD', 'FLUXCAL_SCI']
   - primary_delta_nkeys: 31
   - added_primary_header_kwargs: ['SCI1RIN', 'SCI12ZAB', 'SCI1BAB', 'SCI2ID', 'R1 FIBERFLAT CORR', 'SCI2RA', 'STDSENRZ', 'MODSENRB', 'MODSENMB', 'Z3 FIBER SHIFT', 'B3 FIBERFLAT CORR', 'SKY SKYW_MOON_SEP', 'SKY MOON_DEC', 'SCI2BIN', 'SCIRA', 'SKY SCI_SKYE_SEP', 'STDSENMZ', 'SCI2RAB', 'R3 FIBER SHIFT', 'SKYEDEC', 'SCIPA', 'STD1ZAB', 'MODSENMR', 'SCI12ID', 'SKY MOON_RA', 'SCI2DE', 'MODSENRZ', 'B3 FIBER SHIFT', 'SCI1RA', 'SCI9RA', 'SKY SKYE_ALT', 'STD11BIN', 'SKY MOON_PHASE', 'SCI12ZIN', 'SCI12RAB', 'STD11RAB', 'SCI9FIB', 'STDSENMR', 'SKY SCI_SKYW_SEP', 'STD1RAB', 'MODSENRR', 'STD11BAB', 'SCI12DE', 'R2 FIBER SHIFT', 'SCI9ZIN', 'Z1 FIBER SHIFT', 'STD11ZAB', 'Z1 FIBERFLAT CORR', 'R2 FIBERFLAT CORR', 'SCI1ZAB', 'B2 FIBER SHIFT', 'SCI1ZIN', 'SCI9RIN', 'Z2 FIBER SHIFT', 'SCI1RAB', 'STD1ZIN', 'R1 FIBER SHIFT', 'SKYERA', 'SKYWDEC', 'SCI9BAB', 'METREC', 'SKY MOON_ALT', 'SCI12RIN', 'STD1BAB', 'SKYEPA', 'STDSENRR', 'B1 FIBER SHIFT', 'STDSENRB', 'SCI2FIB', 'SCI9RAB', 'SCIDEC', 'R3 FIBERFLAT CORR', 'STD11ZIN', 'SCI12RA', 'Z2 FIBERFLAT CORR', 'SKY SKYW_ALT', 'SCI12BAB', 'SCI9ID', 'SCI9DE', 'SKY SCI_MOON_SEP', 'SCI2BAB', 'B1 FIBERFLAT CORR', 'Z3 FIBERFLAT CORR', 'SKY SKYW_SH_HGHT', 'STDSENMB', 'SCI12FIB', 'SKY SCI_SH_HGHT', 'SCI2ZAB', 'STD11RIN', 'SCI1ID', 'MODSENMZ', 'SCI9BIN', 'SKYWPA', 'SCI12BIN', 'SKY SKYE_SH_HGHT', 'SCI2ZIN', 'SKYWRA', 'B2 FIBERFLAT CORR', 'STD1BIN', 'SKY MOON_FLI', 'SKY SKYE_MOON_SEP', 'SCI1FIB', 'SCI1DE', 'SKY SUN_ALT', 'SCI2RIN', 'SCI1BIN', 'SCI9ZAB', 'STD1RIN', 'SKY SCI_ALT']
   - removed_primary_header_kwargs: ['SCI7DE', 'IFUCENDE', 'SCI13RA', 'SCI7RAB', 'GEOCORONAL SKYE_SH_HGHT', 'SCI3RAB', 'SCI11BAB', 'SCI14ZAB', 'SCI3RIN', 'SCI13BAB', 'SCI14BAB', 'SCI14FIB', 'SCI7BIN', 'IFUCENRA', 'SCI7FIB', 'SCI11BIN', 'SCI7ZIN', 'SKYMODEL SKYW_ALT', 'SCI7RIN', 'SCI14RIN', 'SCI3RA', 'SKYMODEL SKYE_ALT', 'SCI3ID', 'SCI11RIN', 'SCI13RAB', 'SCI3DE', 'SKYMODEL MOON_DEC', 'SCI13RIN', 'SCI13BIN', 'SCI3FIB', 'SCI3BIN', 'GEOCORONAL SKYW_SH_HGHT', 'SCI13ID', 'GEOCORONAL SCI_SH_HGHT', 'SCI3BAB', 'SCI11ID', 'SCI13DE', 'SCI11RA', 'SKYMODEL SKYE_RHO', 'SCI14BIN', 'SKYMODEL SKYW_RHO', 'SCI7BAB', 'SCI14DE', 'SKYMODEL SCI_RHO', 'SCI13ZIN', 'SCI3ZAB', 'SCI13FIB', 'IFUCENPA', 'SCI11RAB', 'SCI11ZAB', 'SCI11FIB', 'SKYMODEL MOON_FLI', 'SKYMODEL MOON_PHASE', 'SKYMODEL MOON_RA', 'SCI14ID', 'SCI11DE', 'SCI11ZIN', 'SCI7ID', 'SKYMODEL MOONALT', 'SCI14RAB', 'SKYMODEL SCI_ALT', 'SCI14RA', 'SCI3ZIN', 'SCI7RA', 'SKYMODEL SUNALT', 'SKYMODEL ALPHA', 'SCI14ZIN', 'SCI7ZAB', 'SCI13ZAB']
