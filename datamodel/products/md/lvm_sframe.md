...
Describes changes to the datamodel product and/or file structure from one release to another
 - WORK
   - from: DR20
   - removed_hdus: ['FLUXCAL_MOD', 'FLUXCAL_STD', 'FLUXCAL_SCI']
   - primary_delta_nkeys: 482
   - added_primary_header_kwargs: ['AMP2 TRIMSEC', 'FIBER WIDTH AVG', 'SKYMODEL SKYE RHO', 'SKYMODEL SCI ALPHA', 'SKYMODEL SKYE TIME', 'WAVE SKYOFF_b3', 'SKYMODEL SKYW SM_H', 'SKYMODEL SCI EMIS_STR', 'FIBER WIDTH MIN', 'AMP4 GAIN', 'SKYMODEL SCI TIME', 'GEOCORONAL SKYE SHADOW_HEIGHT', 'SKYMODEL SKYW LON_ECL', 'SKYMODEL SKYW ALT', 'SKYMODEL SKYE O2COLUMN', 'SKYMODEL SCI CALCDS', 'SKYMODEL SKYE MOONDIST', 'SKYMODEL SCI SM_H', 'AMP2 GAIN', 'WAVE SKYOFF_b1', 'SKYMODEL SCI PRES', 'FFIBVAR', 'WAVE SKYOFF_r1', 'SKYMODEL SKYW EMIS_STR', 'SKYMODEL SCI MOONSCAL', 'SKYMODEL SCI LAT_ECL', 'WAVE SKYOFF_z2', 'SKYMODEL SCI TEMP_STR', 'IFIBVAR', 'STD12RIN', 'SKYMODEL SKYW RHO', 'FIBER WIDTH MAX', 'FIBER CENT SIG', 'SKYMODEL SKYE SSA', 'STD12RAB', 'SKYMODEL SCI O2COLUMN', 'SKYMODEL SKYE SEASON', 'FIBER CENT AVG', 'SKYMODEL SKYW SSA', 'SKYMODEL SCI ALTMOON', 'AMP4 OVERSCAN_STD', 'SKYMODEL SKYW LAT_ECL', 'WAVE SKYOFF_r2', 'SKYMODEL SKYE MOONSCAL', 'WAVE SKYOFF_r3', 'SKYMODEL SKYE ALPHA', 'SKYMODEL SKYE LAT_ECL', 'SKYMODEL SKYE ALT', 'FIBER CENT MIN', 'AMP2 OVERSCAN_STD', 'STD12ZIN', 'GEOCORONAL SCI SHADOW_HEIGHT', 'AMP3 OVERSCAN_STD', 'WAVE SKYOFF_z3', 'SKYMODEL SKYW MOONSCAL', 'SKYMODEL SKYW PRES', 'AMP3 GAIN', 'SKYMODEL SKYE LON_ECL', 'STD12BIN', 'STD12BAB', 'AMP3 TRIMSEC', 'SKYMODEL SKYE MSOLFLUX', 'AMP2 OVERSCAN', 'FIBER WIDTH MED', 'SKYMODEL SCI ALT', 'SKYMODEL SKYW MOONDIST', 'AMP1 TRIMSEC', 'SKYMODEL SKYE SM_H', 'AMP1 GAIN', 'SKYMODEL SKYW SEASON', 'SKYMODEL SCI RHO', 'SKYMODEL SCI MOONDIST', 'AMP2 RDNOISE', 'SKYMODEL SCI MSOLFLUX', 'WAVE SKYOFF_b2', 'AMP4 TRIMSEC', 'JD', 'SKYMODEL SCI LON_ECL', 'BSCALE', 'AMP3 RDNOISE', 'SKYMODEL SKYW CALCDS', 'SKYMODEL SKYE TEMP_STR', 'AMP1 OVERSCAN', 'SKYMODEL SKYW TIME', 'GEOCORONAL SKYW SHADOW_HEIGHT', 'SKYMODEL SKYE SM_HMIN', 'SKYMODEL SKYW ALTMOON', 'SKYMODEL SKYE EMIS_STR', 'SKYMODEL SKYW SM_HMIN', 'AMP3 OVERSCAN', 'WAVE SKYOFF_z1', 'AMP1 RDNOISE', 'SKYMODEL SKYE CALCDS', 'SKYMODEL SCI SEASON', 'SKYMODEL SKYW ALPHA', 'SKYMODEL SKYW MSOLFLUX', 'FIBER CENT MAX', 'SKYMODEL SCI SM_HMIN', 'SKYMODEL SCI SSA', 'FIBER CENT MED', 'SKYMODEL SKYW TEMP_STR', 'STD12ZAB', 'SKYMODEL SKYE PRES', 'FIBER WIDTH SIG', 'SKYMODEL SKYE ALTMOON', 'AMP4 OVERSCAN', 'AMP1 OVERSCAN_STD', 'BZERO', 'SKYMODEL SKYW O2COLUMN', 'AMP4 RDNOISE', 'FLATNAME']
   - removed_primary_header_kwargs: ['Z1 FIBER SHIFT', 'SCI5ID', 'Z3 AMP1 RDNOISE', 'R3 AMP4 RDNOISE', 'B3 AMP3 GAIN', 'SKY MOON_DEC', 'Z1 FIBERFLAT CORR', 'SCI9DE', 'Z2 FIBER WIDTH_AVG', 'STD4HRV', 'Z3 AMP4 OVERSCAN_STD', 'B3 FIBER CENT_MIN', 'R2 AMP3 RDNOISE', 'R2 AMP4 OVERSCAN_MED', 'B1 AMP2 OVERSCAN_STD', 'SKYMODEL MOONSCAL', 'SCI5RIN', 'B3 AMP1 GAIN', 'R2 AMP2 OVERSCAN_STD', 'SKYMODEL EMIS_STR', 'Z3 AMP3 GAIN', 'B1 WAVE SKYOFF', 'R2 AMP3 TRIMSEC', 'Z2 AMP4 OVERSCAN_STD', 'B2 AMP1 OVERSCAN_STD', 'R1 FIBER WIDTH_AVG', 'B3 AMP3 TRIMSEC', 'B2 AMP3 GAIN', 'SKYMODEL SCI_LON_ECL', 'SKYERA', 'SCI1RIN', 'MODSENRZ', 'SKYMODEL SKYW_LAT_ECL', 'B3 FIBER CENT_MAX', 'STD6HRV', 'Z2 AMP4 RDNOISE', 'Z1 FIBER CENT_STD', 'Z3 AMP4 RDNOISE', 'MODSENMZ', 'B2 AMP1 RDNOISE', 'Z2 AMP3 GAIN', 'B3 AMP1 OVERSCAN_MED', 'R2 AMP1 GAIN', 'B3 AMP2 TRIMSEC', 'SCI9ZIN', 'Z1 AMP3 OVERSCAN_STD', 'B3 AMP4 OVERSCAN_MED', 'Z3 AMP1 OVERSCAN_MED', 'B3 AMP4 TRIMSEC', 'B3 AMP1 OVERSCAN_STD', 'Z1 AMP2 OVERSCAN_STD', 'SCI9BAB', 'STD7HRV', 'Z1 FIBER CENT_AVG', 'R1 AMP3 OVERSCAN_STD', 'SKY SKYW_ALT', 'B2 AMP2 OVERSCAN_STD', 'SKYMODEL SEASON', 'Z2 AMP4 GAIN', 'SCI2BIN', 'B3 AMP1 TRIMSEC', 'Z3 FIBER CENT_MIN', 'B3 AMP4 RDNOISE', 'SCI12RAB', 'STD15HRV', 'R3 AMP1 RDNOISE', 'Z2 AMP3 TRIMSEC', 'SCI1RA', 'SCISENMR', 'Z3 FIBER CENT_STD', 'B3 FIBER WIDTH_STD', 'B3 AMP2 RDNOISE', 'Z3 AMP2 TRIMSEC', 'SKY SKYE_ALT', 'SCI9RA', 'SCI5DE', 'Z1 AMP2 TRIMSEC', 'B2 FIBERFLAT CORR', 'B1 AMP1 RDNOISE', 'SCI12FIB', 'R1 AMP2 GAIN', 'Z2 AMP2 TRIMSEC', 'B2 AMP2 RDNOISE', 'B1 AMP2 OVERSCAN_MED', 'B1 AMP3 RDNOISE', 'STDSENRB', 'Z2 AMP2 RDNOISE', 'Z2 WAVE SKYOFF', 'SCI4FIB', 'SKY SCI_MOON_SEP', 'SCI2RA', 'SKYMODEL SCI_LAT_ECL', 'SCI1RAB', 'SCI8RIN', 'SCI5BIN', 'SKY SCI_SH_HGHT', 'R2 AMP4 GAIN', 'SCI5RAB', 'B2 FIBER SHIFT', 'B3 FIBER CENT_AVG', 'SCI1ID', 'Z1 FIBER WIDTH_MIN', 'STDSENRR', 'R3 AMP1 GAIN', 'Z1 AMP4 RDNOISE', 'Z3 AMP3 OVERSCAN_STD', 'SCISENMB', 'SCI8FIB', 'B3 AMP4 GAIN', 'Z2 FIBER CENT_STD', 'STD1HRV', 'B2 AMP3 OVERSCAN_STD', 'SCI4BAB', 'Z1 FIBER WIDTH_STD', 'Z1 AMP4 OVERSCAN_STD', 'Z2 FIBER WIDTH_MIN', 'B2 AMP3 RDNOISE', 'R3 FIBERFLAT CORR', 'WAVE HELIORV_SCI', 'SKYEPA', 'SCISENRR', 'Z3 FIBER SHIFT', 'STDSENMR', 'B2 FIBER WIDTH_MAX', 'STD2HRV', 'B3 FIBER SHIFT', 'B3 AMP2 GAIN', 'SKY SCI_ALT', 'SKY SKYE_SH_HGHT', 'STD10HRV', 'Z2 AMP3 RDNOISE', 'Z2 AMP1 TRIMSEC', 'B1 FIBER SHIFT', 'R2 FIBER SHIFT', 'B2 AMP1 OVERSCAN_MED', 'R2 FIBER WIDTH_STD', 'SKY SKYE_MOON_SEP', 'R2 FIBER WIDTH_AVG', 'R1 FIBER CENT_STD', 'B1 AMP1 OVERSCAN_STD', 'R1 FIBER WIDTH_STD', 'SCI2RIN', 'SCI2DE', 'SCI5BAB', 'SKYWRA', 'R1 AMP4 OVERSCAN_STD', 'COMMIT', 'SCI12ZAB', 'SCISENRB', 'R3 FIBER CENT_AVG', 'STDSENMZ', 'SCI8RAB', 'SKY SUN_ALT', 'R2 FIBERFLAT CORR', 'SCI9ID', 'SCI4ZAB', 'B1 AMP2 RDNOISE', 'B3 AMP3 OVERSCAN_STD', 'R3 AMP1 OVERSCAN_MED', 'Z3 FIBER WIDTH_MIN', 'SCI12ZIN', 'R3 AMP4 OVERSCAN_STD', 'R1 AMP4 OVERSCAN_MED', 'SKY MOON_PHASE', 'Z2 AMP3 OVERSCAN_MED', 'B2 AMP4 OVERSCAN_STD', 'B1 AMP4 OVERSCAN_STD', 'R3 AMP3 OVERSCAN_MED', 'SCI12ID', 'B3 AMP1 RDNOISE', 'R3 AMP3 RDNOISE', 'R1 AMP2 TRIMSEC', 'SCI4ID', 'R1 AMP3 TRIMSEC', 'SCI2ID', 'SKYMODEL TIME', 'R3 AMP3 TRIMSEC', 'SCI4RAB', 'SCI8BAB', 'SCI2FIB', 'Z2 AMP1 GAIN', 'SCI1ZIN', 'SCI4ZIN', 'B3 AMP2 OVERSCAN_STD', 'R2 FIBER CENT_STD', 'Z3 AMP2 OVERSCAN_MED', 'Z2 AMP2 OVERSCAN_MED', 'R3 AMP3 OVERSCAN_STD', 'R1 FIBER CENT_MAX', 'Z3 AMP3 TRIMSEC', 'Z2 AMP3 OVERSCAN_STD', 'B1 FIBER CENT_STD', 'SCI4DE', 'SKY SCI_SKYW_SEP', 'Z1 AMP1 OVERSCAN_STD', 'R2 AMP1 OVERSCAN_STD', 'SCI5RA', 'R1 AMP4 RDNOISE', 'SCI2ZIN', 'Z2 AMP4 TRIMSEC', 'Z1 AMP1 OVERSCAN_MED', 'Z2 FIBERFLAT CORR', 'Z3 WAVE SKYOFF', 'Z3 FIBER CENT_AVG', 'SCI8ZIN', 'R3 FIBER WIDTH_AVG', 'Z1 AMP1 RDNOISE', 'B1 AMP3 GAIN', 'R1 FIBER CENT_AVG', 'R3 AMP2 GAIN', 'B1 AMP4 RDNOISE', 'Z1 AMP2 GAIN', 'MODSENRB', 'SCI9BIN', 'R1 AMP3 GAIN', 'R2 AMP2 OVERSCAN_MED', 'R1 FIBER WIDTH_MIN', 'Z1 AMP1 TRIMSEC', 'Z2 FIBER SHIFT', 'R2 WAVE SKYOFF', 'Z1 FIBER WIDTH_MAX', 'R3 FIBER WIDTH_MIN', 'R3 FIBER WIDTH_STD', 'R2 AMP1 TRIMSEC', 'R2 AMP4 OVERSCAN_STD', 'B3 AMP2 OVERSCAN_MED', 'B2 AMP1 TRIMSEC', 'R3 AMP2 OVERSCAN_MED', 'B3 FIBER WIDTH_MIN', 'SKYMODEL SSA', 'Z3 AMP1 TRIMSEC', 'B2 FIBER WIDTH_STD', 'SKY MOON_RA', 'R1 AMP2 RDNOISE', 'B2 AMP4 OVERSCAN_MED', 'SCI12RIN', 'STD13HRV', 'R3 FIBER SHIFT', 'STD5HRV', 'SCI8BIN', 'R1 AMP3 RDNOISE', 'STD11HRV', 'R1 AMP4 GAIN', 'B3 FIBER CENT_STD', 'Z3 FIBERFLAT CORR', 'B2 AMP2 GAIN', 'B1 FIBER CENT_AVG', 'SCI8ZAB', 'R2 AMP2 RDNOISE', 'B1 FIBER CENT_MIN', 'B3 AMP3 OVERSCAN_MED', 'SKYMODEL O2COLUMN', 'R2 AMP4 TRIMSEC', 'R3 AMP1 OVERSCAN_STD', 'SCI5ZAB', 'R1 AMP3 OVERSCAN_MED', 'R1 AMP1 OVERSCAN_MED', 'R2 FIBER CENT_MIN', 'B2 AMP2 TRIMSEC', 'R3 AMP4 GAIN', 'Z3 AMP1 GAIN', 'B2 FIBER CENT_AVG', 'SCI1FIB', 'SKY MOON_ALT', 'R3 FIBER CENT_STD', 'SCI12RA', 'SCISENMZ', 'R1 AMP1 TRIMSEC', 'R1 AMP1 OVERSCAN_STD', 'B2 WAVE SKYOFF', 'R1 WAVE SKYOFF', 'STD12HRV', 'R3 AMP1 TRIMSEC', 'SKYMODEL SM_HMIN', 'R3 AMP3 GAIN', 'Z1 FIBER CENT_MIN', 'MODSENMB', 'R1 FIBER WIDTH_MAX', 'R3 AMP4 OVERSCAN_MED', 'Z1 AMP2 RDNOISE', 'MODSENRR', 'B1 AMP3 TRIMSEC', 'B2 FIBER WIDTH_MIN', 'B2 AMP4 GAIN', 'SCI1ZAB', 'Z3 AMP4 OVERSCAN_MED', 'R1 FIBERFLAT CORR', 'R2 AMP3 OVERSCAN_STD', 'R1 AMP4 TRIMSEC', 'Z1 FIBER WIDTH_AVG', 'Z2 AMP4 OVERSCAN_MED', 'Z3 FIBER WIDTH_AVG', 'SCI5FIB', 'SKYMODEL SKYE_LON_ECL', 'B2 AMP3 TRIMSEC', 'R2 FIBER CENT_MAX', 'B1 AMP1 GAIN', 'B1 AMP2 GAIN', 'Z1 AMP3 GAIN', 'B1 AMP2 TRIMSEC', 'SCI4RA', 'SCI2BAB', 'B2 AMP4 TRIMSEC', 'B2 FIBER CENT_MAX', 'Z2 AMP2 GAIN', 'SCI8ID', 'B2 AMP1 GAIN', 'Z2 AMP1 OVERSCAN_STD', 'B3 FIBER WIDTH_AVG', 'R3 AMP2 OVERSCAN_STD', 'R3 AMP2 TRIMSEC', 'SCI4RIN', 'SCI9RAB', 'Z2 AMP2 OVERSCAN_STD', 'R2 AMP4 RDNOISE', 'B1 FIBER CENT_MAX', 'SKYWPA', 'Z3 AMP4 GAIN', 'SCI1DE', 'B1 AMP4 TRIMSEC', 'SCI9ZAB', 'R2 AMP3 GAIN', 'Z1 AMP4 OVERSCAN_MED', 'Z1 AMP3 TRIMSEC', 'SKYMODEL MSOLFLUX', 'SCISENRZ', 'Z1 AMP1 GAIN', 'SCI1BIN', 'Z3 FIBER WIDTH_MAX', 'SCIPA', 'R1 AMP1 GAIN', 'SCIRA', 'SCI8DE', 'STD3HRV', 'R1 FIBER CENT_MIN', 'Z3 AMP3 RDNOISE', 'Z3 AMP2 RDNOISE', 'SCI2ZAB', 'R1 FIBER SHIFT', 'B3 AMP3 RDNOISE', 'QAQUAL', 'STD8HRV', 'R2 AMP3 OVERSCAN_MED', 'B3 FIBERFLAT CORR', 'R2 AMP2 GAIN', 'SCI5ZIN', 'B2 AMP4 RDNOISE', 'R2 FIBER WIDTH_MAX', 'SCI12BIN', 'SKYMODEL TEMP_STR', 'Z2 FIBER CENT_MAX', 'Z3 AMP2 OVERSCAN_STD', 'SKYMODEL PRES', 'WAVE HELIORV_SKYE', 'R3 FIBER CENT_MIN', 'Z2 AMP1 OVERSCAN_MED', 'SKYMODEL SKYE_LAT_ECL', 'Z3 AMP4 TRIMSEC', 'R2 AMP2 TRIMSEC', 'SCIDEC', 'Z1 FIBER CENT_MAX', 'B3 FIBER WIDTH_MAX', 'Z2 FIBER CENT_MIN', 'SCI1BAB', 'SCI9RIN', 'B2 AMP3 OVERSCAN_MED', 'R2 AMP1 OVERSCAN_MED', 'B1 AMP1 OVERSCAN_MED', 'SCI9FIB', 'B2 FIBER CENT_MIN', 'STDSENRZ', 'B2 FIBER WIDTH_AVG', 'STD14HRV', 'SKYMODEL CALCDS', 'Z1 AMP2 OVERSCAN_MED', 'SKYMODEL SM_H', 'SKYMODEL SKYW_LON_ECL', 'Z1 AMP4 GAIN', 'Z2 FIBER WIDTH_STD', 'SKY SKYW_SH_HGHT', 'B1 AMP4 OVERSCAN_MED', 'MODSENMR', 'R2 FIBER CENT_AVG', 'SKYWDEC', 'SCI4BIN', 'B1 AMP1 TRIMSEC', 'Z1 AMP3 RDNOISE', 'Z1 AMP4 TRIMSEC', 'R1 AMP2 OVERSCAN_MED', 'Z3 FIBER CENT_MAX', 'SCI12BAB', 'B1 FIBER WIDTH_AVG', 'B1 FIBER WIDTH_MAX', 'Z3 FIBER WIDTH_STD', 'Z2 FIBER CENT_AVG', 'B3 AMP4 OVERSCAN_STD', 'WAVE HELIORV_SKYW', 'B3 WAVE SKYOFF', 'SKYMODEL MOONDIST', 'R3 WAVE SKYOFF', 'Z1 AMP3 OVERSCAN_MED', 'R2 FIBER WIDTH_MIN', 'R3 AMP4 TRIMSEC', 'Z3 AMP2 GAIN', 'STDSENMB', 'SCI12DE', 'R1 AMP2 OVERSCAN_STD', 'R3 FIBER WIDTH_MAX', 'B1 FIBERFLAT CORR', 'Z1 WAVE SKYOFF', 'Z2 FIBER WIDTH_MAX', 'R2 AMP1 RDNOISE', 'B1 FIBER WIDTH_STD', 'SKYEDEC', 'B2 AMP2 OVERSCAN_MED', 'SKY SCI_SKYE_SEP', 'R1 AMP1 RDNOISE', 'B1 AMP3 OVERSCAN_MED', 'STD9HRV', 'R3 FIBER CENT_MAX', 'SKY MOON_FLI', 'B1 AMP3 OVERSCAN_STD', 'R3 AMP2 RDNOISE', 'Z2 AMP1 RDNOISE', 'B1 FIBER WIDTH_MIN', 'Z3 AMP1 OVERSCAN_STD', 'B2 FIBER CENT_STD', 'B1 AMP4 GAIN', 'QAFLAG', 'Z3 AMP3 OVERSCAN_MED', 'SCI8RA', 'SKY SKYW_MOON_SEP', 'SCI2RAB']
 - DR20
   - from: DR19
   - added_hdus: ['FLUXCAL_MOD', 'FLUXCAL_STD', 'FLUXCAL_SCI']
   - primary_delta_nkeys: 31
   - added_primary_header_kwargs: ['Z1 FIBER SHIFT', 'SCIPA', 'STD1ZAB', 'SCIRA', 'B1 FIBER SHIFT', 'R2 FIBER SHIFT', 'SKY MOON_DEC', 'Z1 FIBERFLAT CORR', 'SKY SKYE_MOON_SEP', 'SCI9DE', 'SKY MOON_RA', 'SCI2ZAB', 'STD11BIN', 'R1 FIBER SHIFT', 'SCI2RIN', 'B3 FIBERFLAT CORR', 'SCI2DE', 'SCI12RIN', 'METREC', 'SKYWRA', 'SCI12BIN', 'SCI12ZAB', 'R3 FIBER SHIFT', 'STDSENMZ', 'SKY SUN_ALT', 'R2 FIBERFLAT CORR', 'SCI9ID', 'SCI12ZIN', 'SKYERA', 'SCIDEC', 'Z3 FIBERFLAT CORR', 'SCI1RIN', 'MODSENRZ', 'SKY MOON_PHASE', 'SCI1BAB', 'SCI9RIN', 'SKY SKYW_MOON_SEP', 'MODSENMZ', 'SCI9FIB', 'SCI12ID', 'SCI9ZIN', 'SCI1FIB', 'STDSENRZ', 'SKY MOON_ALT', 'SCI12RA', 'STD1RIN', 'SCI9BAB', 'SCI2ID', 'SKY SKYW_SH_HGHT', 'MODSENMR', 'SKY SKYW_ALT', 'SKYWDEC', 'SCI2BIN', 'MODSENMB', 'SCI12RAB', 'SCI2FIB', 'MODSENRR', 'SCI1ZIN', 'SCI1RA', 'SCI12BAB', 'SKY SKYE_ALT', 'SCI9RA', 'B2 FIBERFLAT CORR', 'SCI12FIB', 'SKY SCI_SKYW_SEP', 'SCI1ZAB', 'R1 FIBERFLAT CORR', 'STDSENRB', 'STD1ZIN', 'SCI2ZIN', 'STD1BAB', 'SKY SCI_MOON_SEP', 'SCI2RA', 'SCI1RAB', 'STDSENMB', 'SKY SCI_SH_HGHT', 'SCI12DE', 'STD11RAB', 'STD11ZIN', 'Z2 FIBERFLAT CORR', 'B2 FIBER SHIFT', 'STD1RAB', 'SCI2BAB', 'SCI1ID', 'STD11ZAB', 'B1 FIBERFLAT CORR', 'STD11RIN', 'STDSENRR', 'SKYEDEC', 'SKY SCI_SKYE_SEP', 'SCI9RAB', 'MODSENRB', 'SKYWPA', 'SKY MOON_FLI', 'SCI1DE', 'SCI9BIN', 'R3 FIBERFLAT CORR', 'SCI9ZAB', 'SKYEPA', 'STD11BAB', 'Z3 FIBER SHIFT', 'STDSENMR', 'Z2 FIBER SHIFT', 'STD1BIN', 'B3 FIBER SHIFT', 'SKY SCI_ALT', 'SKY SKYE_SH_HGHT', 'SCI1BIN', 'SCI2RAB']
   - removed_primary_header_kwargs: ['SKYMODEL SKYW_RHO', 'SCI3RAB', 'SCI14RAB', 'SCI14ID', 'SCI7FIB', 'SCI11ID', 'SCI7RA', 'SCI7BAB', 'SCI14ZIN', 'SCI3BAB', 'SKYMODEL SCI_ALT', 'SCI7ID', 'SCI14ZAB', 'IFUCENRA', 'SCI14FIB', 'GEOCORONAL SCI_SH_HGHT', 'SCI7ZIN', 'SCI3FIB', 'SCI14BIN', 'SCI7RIN', 'GEOCORONAL SKYW_SH_HGHT', 'SCI3ZAB', 'SKYMODEL SCI_RHO', 'SCI7DE', 'SCI7RAB', 'SKYMODEL MOON_FLI', 'SCI7BIN', 'SCI13BIN', 'SCI11FIB', 'SKYMODEL SKYE_RHO', 'SCI13ID', 'SCI14RIN', 'SCI13RIN', 'SCI11BAB', 'SCI13ZAB', 'SKYMODEL SKYE_ALT', 'SCI11ZIN', 'SCI13ZIN', 'SCI11RAB', 'SCI13BAB', 'SCI13FIB', 'SCI11RA', 'SCI13RAB', 'SKYMODEL SUNALT', 'SCI13RA', 'IFUCENDE', 'SCI11ZAB', 'SCI14DE', 'SCI3RIN', 'SCI3ID', 'SKYMODEL ALPHA', 'SCI11BIN', 'IFUCENPA', 'SKYMODEL MOON_PHASE', 'SKYMODEL MOON_RA', 'SKYMODEL MOON_DEC', 'SCI3ZIN', 'SCI3RA', 'SCI13DE', 'SCI3BIN', 'SCI11DE', 'SKYMODEL SKYW_ALT', 'SCI11RIN', 'SKYMODEL MOONALT', 'GEOCORONAL SKYE_SH_HGHT', 'SCI14BAB', 'SCI14RA', 'SCI3DE', 'SCI7ZAB']
