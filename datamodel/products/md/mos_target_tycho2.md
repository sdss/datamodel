...
### Naming Convention
$MOS_TARGET/[V_TARG]/[FTYPE]/mos_tycho2-[NUM].[FTYPE] with FTYPE='fits', V_TARG='2.0.0', and NUM=1..2 for DR20.
...
| --- | --- | --- | --- |
 ...
 | designation2 | char[12] |  | Unique Tycho designation. Similar to designation but without padding zeros. |
