# Data Model: astraAllVisitSLAM


Results from the SLAM astra pipeline for each visit
...
### Naming Convention
$MWM_ASTRA/0.5.0/summary/astraAllVisitSLAM-0.5.0.fits.gz
...
| CREATED | 23-11-16 08:04:22 | File creation time (UTC %y-%m-%d %H:%M:%S) |
...
### HDU1:
SLAM results for each visit from BOSS
...
| NAXIS1 | 1157 | length of dimension 1 |
| NAXIS2 | 74819 | length of dimension 2 |
...
| TDIM182 | (18) |  |
| TDIM183 | (18) |  |
| CHECKSUM | gJMigHLhgHLhgHLh | HDU checksum updated 2023-11-16T01:04:37 |
| DATASUM | 3882012972 | data unit checksum updated 2023-11-16T01:04:37 |
...
### HDU2:
SLAM results for each visit from APOGEE
...
| BITPIX | 8 | array data type |
| NAXIS | 2 | number of array dimensions |
| NAXIS1 | 862 | length of dimension 1 |
...
| PIPELINE | Slam | Pipeline name |
| V_ASTRA | 0.5.0 | Astra version |
| CREATED | 23-11-16 08:04:37 | File creation time (UTC %y-%m-%d %H:%M:%S) |
| TDIM16 | (1) |  |
| COMMENT | See https://www.ipac.caltech.edu/2mass/releases/allsky/doc/sec2_2a.html |  |
| COMMENT | See https://catalog.unwise.me/catalogs.html |  |
| COMMENT | See https://irsa.ipac.caltech.edu/data/SPITZER/GLIMPSE/gator_docs/ |  |
| CHECKSUM | UniYalfWUlfWalfW | HDU checksum updated 2023-11-16T01:04:38 |
| DATASUM | 0 | data unit checksum updated 2023-11-16T01:04:38 |
