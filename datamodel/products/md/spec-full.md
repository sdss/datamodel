# Data Model: spec-full


BOSS Target spectra with individual exposures
...
### HDU2: SPALL
Summary metadata copied from spAll
...
| --- | --- | --- | --- |
 ...
 | PMRA | float32 | rmas | Proper motion in RA (pmra is a true angle) |
 | PMDEC | float32 | mas | Proper motion in Dec |
 ...
 | ZOFFSET | float32 | micron | Backstopping offset distance |
 ...
 | SEEING20 | float32 | arcsec | Mean 20% seeing during exposures (arcsec) |
 | SEEING50 | float32 | arcsec | Mean 50% seeing during exposures (arcsec) |
 | SEEING80 | float32 | arcsec | Mean 80% seeing during exposures (arcsec) |
 ...
 | XCSAO_TEFF | float32 | deg | Interpolated temperature from pyXCSAO |
 | XCSAO_ETEFF | float32 | deg | Uncertainty in Interpolated temperature |
 | XCSAO_LOGG | float32 | cm/s/s | Interpolated surface gravity from pyXCSAO |
 | XCSAO_ELOGG | float32 | cm/s/s | Uncertainty in Interpolated surface gravity |
 | XCSAO_FEH | float32 | Sun | Interpolated metallicity from pyXCSAO |
 | XCSAO_EFEH | float32 | Sun | Uncertainty in interpolated metallicity |
