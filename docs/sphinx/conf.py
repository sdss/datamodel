...
try:
    ...
    __version__ = get_package_version(__file__, 'sdss-datamodel') or 'dev'
...
extensions = ['sphinx.ext.autodoc', 'sphinx.ext.napoleon', 'sphinx.ext.autosummary',
              ...
              'sphinx.ext.intersphinx', 'sphinxarg.ext']
...
project = 'datamodel'
copyright = '{0}, {1}'.format('2020', 'Joel Brownstein')
...
.. |datamodel_version| replace:: {__version__}
"""
...
htmlhelp_basename = '{0}pdoc'.format('datamodel')
...
man_pages = [
    (master_doc, 'datamodel', u'{0} Documentation'.format(project),
     [author], 1)
]
...
if use_releases == 'yes':
    ...
    releases_github_path = 'sdss/datamodel'
